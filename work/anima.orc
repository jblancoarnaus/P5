...
#2	SenoFM    ADSR_A=0.2; ADSR_D=0.05; ADSR_S=0.8; ADSR_R=0.1; setting=0.99995; I1=0;I2=1;N1=1;N2=10;file=tables/harp_1cycle.wav;
#2	Seno	ADSR_A=0.02; ADSR_D=0.02; ADSR_S=0.05; ADSR_R=0.05;  file=tables/saw_1cycle.wav;

#3	Strings	ADSR_A=0.02; ADSR_D=0.2; ADSR_S=0.15; ADSR_R=0.2; file=tables/trumpet_1cycle.wav;
#4	Strings	ADSR_A=0.6; ADSR_D=0; ADSR_S=0.3; ADSR_R=0.1; file=tables/trombone_1cycle.wav;
#5	Strings	ADSR_A=0.01; ADSR_D=0.01; ADSR_S=0.6; ADSR_R=0.2; file=tables/choir_1cycle.wav;
#6	Strings	ADSR_A=0.05; ADSR_D=0.01; ADSR_S=0.2; ADSR_R=0.5; file=tables/woodwind_1cycle.wav;
#7	Strings    ADSR_A=0.1; ADSR_D=0.1; ADSR_S=0.35; ADSR_R=0.1; file=tables/piano_1cycle.wav;
...
#9	PercussionSample    file=tables/drum_sample.wav; volume=0.10;
#12	Strings	ADSR_A=0.1; ADSR_D=0; ADSR_S=0.2; ADSR_R=0.15; file=tables/synth_bass_1cycle.wav;
